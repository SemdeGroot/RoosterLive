...
def send_single_omzettingslijst_email(
    to_email: str,
    name: str,
    pdf_content: bytes,
    filename: str,
    ...
    In de bijlage vindt u de <strong>omzettingslijst</strong> voor <strong>week {week}</strong> ({dag_label}). 
    Dit overzicht toont per patiënt de gevraagde en geleverde geneesmiddelen, inclusief de ingangsdatum van de omzetting.
    </p>
    ...
    footer_text = (
        ...
        "omzettingslijst is geregistreerd."
    )

    # gebruikt jouw bestaande mail wrapper + inline logo (cid:logo)
    ...
    text_content = (
        f"Beste {name},\n\n"
        f"In de bijlage vindt u de omzettingslijst voor week {week} ({dag_label}).\n"
        "Het overzicht bevat per patiënt de gevraagde en geleverde geneesmiddelen.\n\n"
