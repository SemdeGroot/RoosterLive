...
TILE_GROUPS = {
    "home": [
        ...
        {"name": "Onboarding", "img": "onboarding-lucide.svg", "badge_class": C["violet"], "url_name": "onboarding_tiles", "perm": "can_view_onboarding", "desc": "Startinformatie en teamoverzicht."},
        ...
        {"name": "Bezorgers", "img": "bezorgers-lucide.svg", "badge_class": C["lime"], "url_name": "bezorgers_tiles", "perm": "can_view_bezorgers", "desc": "Bakken bezorgen en status."},
        {"name": "Profiel", "img": "profiel-lucide.svg", "badge_class": C["pink"], "url_name": "profiel", "perm": "can_access_profiel", "desc": "App Instellingen en gegevens beheren."},
    ...
    "personeel": [
        {"name": "Teamdashboard", "img": "teamdashboard-lucide.svg", "badge_class": C["slate"], "url_name": "beschikbaarheidpersoneel", "perm": "can_view_beschikbaarheidsdashboard", "desc": "Overzicht van beschikbaarheid."},
        ...
        {"name": "Uren doorgeven", "img": "clock-lucide.svg", "badge_class": C["yellow"], "url_name": "urendoorgeven", "perm": "can_view_urendoorgeven", "desc": "Geef je uren gemakkelijk door."},
        {"name": "Ziek melden", "img": "ziekmelden-lucide.svg", "badge_class": C["red"], "url_name": "ziekmelden", "perm": "can_view_ziekmelden", "desc": "Snel personeel ziekmelden."},
    ...
    "onboarding": [
        {"name": "Team", "img": "team-lucide.svg", "badge_class": C["teal"], "url_name": "whoiswho", "perm": "can_view_whoiswho", "desc": "Overzicht van mensen in team."},
        {"name": "Formulieren", "img": "onboarding_forms-lucide.svg", "badge_class": C["stone"], "url_name": "onboarding_formulieren", "perm": "can_view_forms", "desc": "Belangrijke onboarding formulieren."},
        {"name": "Checklist", "img": "checklist-lucide.svg", "badge_class": C["lime"], "url_name": "checklist", "perm": "can_view_checklist", "desc": "Onboarding checklist (voor beheerders)."},
    ],

    "baxter": [
        {"name": "Voorraad", "img": "voorraad-lucide.svg", "badge_class": C["blue"], "url_name": "medications", "perm": "can_view_av_medications", "desc": "Zoek en bekijk baxtervoorraad."},
    ...
    "openbare": [
        ...
        {"name": "KompasGPT", "img": "kompasgpt-lucide.svg", "badge_class": C["fuchsia"], "url_name": "kompasgpt", "perm": "can_view_kompasgpt", "desc": "Stel je vragen over medicatie, groepen en indicaties."},
        {"name": "Houdbaarheidscheck", "img": "houdbaarheidcheck-lucide.svg", "badge_class": C["orange"], "url_name": "houdbaarheidcheck", "perm": "can_edit_houdbaarheidcheck", "desc": "Zoek snel houdbaarheid op van geneesmiddelen."},
        {"name": "Werkafspraken", "img": "werkafspraken-lucide.svg", "badge_class": C["stone"], "url_name": "policies", "perm": "can_view_policies", "desc": "Afspraken en beleid."},
    ],

    "instellings": [
        {"name": "Medicatiebeoordeling", "img": "medicatiebeoordeling-lucide.svg", "badge_class": C["violet"], "url_name": "medicatiebeoordeling_tiles", "perm": "can_view_medicatiebeoordeling", "desc": "tart of beheer reviews."},
        {"name": "Review planner", "img": "reviewplanner-lucide.svg", "badge_class": C["sky"], "url_name": "reviewplanner", "perm": "can_view_reviewplanner", "desc": "Plan en registreer uitgevoerde reviews."},
        {"name": "KompasGPT", "img": "kompasgpt-lucide.svg", "badge_class": C["fuchsia"], "url_name": "kompasgpt", "perm": "can_view_kompasgpt", "desc": "Stel je vragen over medicatie, groepen en indicaties."},
    ...
    "medicatiebeoordeling": [
        ...
        {"name": "Instellingen", "img": "standaardvragen-lucide.svg", "badge_class": C["purple"], "url_name": "medicatiebeoordeling_settings", "perm": "can_perform_medicatiebeoordeling", "desc": "Beheer instellingen voor reviews"},
    ],
    ...
    "beheer": [
        ...
        {"name": "Taken", "img": "admin_taken-lucide.svg", "badge_class": C["amber"], "url_name": "admin_taken", "perm": "can_access_admin", "desc": "Taken en minimale bezetting beheren."},
        {"name": "Functies", "img": "admin-functies-lucide.svg", "badge_class": C["pink"], "url_name": "admin_functies", "perm": "can_access_admin", "desc": "Functies en ranking."},
