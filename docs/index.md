...
De app is gebouwd als een **Progressive Web App (PWA)**. Dit betekent dat je de applicatie direct vanuit je browser op je telefoon of computer kunt installeren als een normale app.
...
Mocht er iets onduidelijk zijn, neem dan contact op met de beheerder.