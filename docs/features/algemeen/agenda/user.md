...
## Doel van de module
Het doel van de Agenda module is om medewerkers van de **Apotheek Jansen App** op de hoogte te houden van belangrijke gebeurtenissen, uitjes en algemene afspraken binnen de organisatie.
...
## Werkwijze
De agenda is direct zichtbaar op het hoofdscherm van de applicatie in de vorm van tegels of een lijstoverzicht. 
...
- Agendapunten worden automatisch gesynchroniseerd met de WebCal-feed "Apotheek Jansen Agenda".
