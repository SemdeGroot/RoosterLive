...
## Technisch ontwerp
De Review planner module is opgebouwd rondom het `ReviewPlanner` model. De interface maakt gebruik van een interactieve tabel met autosave-functionaliteit en een modal-venster voor gedetailleerde invoer. Voor de export naar Excel wordt de `openpyxl` bibliotheek gebruikt.
